...
public class ObjectValue {
	...
	/**
	 * If the object is wearable then the object can also be armour Armour means
	 * that it offers the user some protection from one or more types of attack
	 * specified in the /protection folder.
	 * 
	 * @return A String containing "true" or "false"
	 */
	public String isArmor() {
		String fileLoc = database + "/objects/" + obj + "/settings/armor";
		FileOperations open = new FileOperations(fileLoc);
		String armor = open.getLine();
		return armor;
	}

	/**
	 * Sets whether or not the object offers protection from certain types of
	 * attack
	 * 
	 * @param armor A String containing a "true" or "false" value
	 */
	 ...
	 * 
	 * @return A String containing the decription
	 */
	...
	public void setDesc(String desc) {
		String fileLoc = database + "/objects/" + obj + "/modifiers/desc";
		FileOperations open = new FileOperations(fileLoc);
		open.setLine(desc);
	}
	...
	public void setTitle(String title) {
		String fileLoc = database + "/objects/" + obj + "/modifiers/title";
		FileOperations open = new FileOperations(fileLoc);
		open.setLine(title);
	}
	...
	public void setAcidProtection(String acid) {
		String fileLoc = database + "/objects/" + obj + "/modifiers/acidProtection";
		FileOperations open = new FileOperations(fileLoc);
		open.setLine(acid);
	}
	...
	public void setFireProtection(String fire) {
		String fileLoc = database + "/objects/" + obj + "/modifiers/fireProtection";
		FileOperations open = new FileOperations(fileLoc);
		open.setLine(fire);
	}
	...
	public void setHitProtection(String hit) {
		String fileLoc = database + "/objects/" + obj + "/modifiers/hitProtection";
		FileOperations open = new FileOperations(fileLoc);
		open.setLine(hit);
	}
	...
	public void setMagicProtection(String magic) {
		String fileLoc = database + "/objects/" + obj + "/modifiers/magicProtection";
		FileOperations open = new FileOperations(fileLoc);
		open.setLine(magic);
	}
	...
	public void setPiercedProtection(String pierce) {
		String fileLoc = database + "/objects/" + obj + "/modifiers/pierceProtection";
		FileOperations open = new FileOperations(fileLoc);
		open.setLine(pierce);
	}
	...
	public void setRangedProtection(String ranged) {
		String fileLoc = database + "/objects/" + obj + "/modifiers/rangedProtection";
		FileOperations open = new FileOperations(fileLoc);
		open.setLine(ranged);
	}
