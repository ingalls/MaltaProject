...
public class NPCValue {
	...
	public void setMaxDexterity(String dex){
		String fileLoc = database + "/charProfile/"+npc+"/maxDexterity";
		FileOperations open = new FileOperations(fileLoc);
		open.setLine(dex);
	}
	...
	public void setMinDexterity(String dex){
		String fileLoc = database + "/charProfile/"+npc+"/minDexterity";
		FileOperations open = new FileOperations(fileLoc);
		open.setLine(dex);
	}
	...
	public void setXP(String xp){
		String fileLoc = database + "/charProfile/"+npc+"/experience";
		FileOperations open = new FileOperations(fileLoc);
		open.setLine(xp);
	}
	...
	public void setMinHealth(String health){
		String fileLoc = database + "/charProfile/"+npc+"/minHealth";
		FileOperations open = new FileOperations(fileLoc);
		open.setLine(health);
	}
	...
	public void setMaxHealth(String health){
		String fileLoc = database + "/charProfile/"+npc+"/maxHealth";
		FileOperations open = new FileOperations(fileLoc);
		open.setLine(health);
	}
	...
	public void setMaxIntelligence(String intel){
		String fileLoc = database + "/charProfile/"+npc+"/maxIntelligence";
		FileOperations open = new FileOperations(fileLoc);
		open.setLine(intel);
	}
	...
	public void setMaxStrength(String str){
		String fileLoc = database + "/charProfile/"+npc+"/maxStrength";
		FileOperations open = new FileOperations(fileLoc);
		open.setLine(str);
	}
	...
	public void setMinStrength(String str){
		String fileLoc = database + "/charProfile/"+npc+"/minStrength";
		FileOperations open = new FileOperations(fileLoc);
		open.setLine(str);
	}
	...
	public void setMinGold(String gold){
		String fileLoc = database + "/charProfile/"+npc+"/minGold";
		FileOperations open = new FileOperations(fileLoc);
		open.setLine(gold);
	}
	...
	public void setMaxGold(String gold){
		String fileLoc = database + "/charProfile/"+npc+"/maxGold";
		FileOperations open = new FileOperations(fileLoc);
		open.setLine(gold);
	}
	...
	public void setMinWeight(String weight){
		String fileLoc = database + "/charProfile/"+npc+"/minWeight";
		FileOperations open = new FileOperations(fileLoc);
		open.setLine(weight);
	}
	...
	public void setMaxWeight(String weight){
		String fileLoc = database + "/charProfile/"+npc+"/maxWeight";
		FileOperations open = new FileOperations(fileLoc);
		open.setLine(weight);
	}
	...
	public void setMinWisdom(String wis){
		String fileLoc = database + "/charProfile/"+npc+"/minWisdom";
		FileOperations open = new FileOperations(fileLoc);
		open.setLine(wis);
	}
	...
	public void setMaxWisdom(String wis){
		String fileLoc = database + "/charProfile/"+npc+"/maxWisdom";
		FileOperations open = new FileOperations(fileLoc);
		open.setLine(wis);
	}
	...
	public void setDrop(String drop){
		String fileLoc = database + "/charProfile/"+npc+"/drop";
		FileOperations open = new FileOperations(fileLoc);
		open.setLine(drop);
	}
