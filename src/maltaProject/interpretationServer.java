...
//TODO Examine Command Code

//TODO get user tick generating health
//TODO --> Get fight code working

//TODO add new line after inventory command
...
//TODO Allow some stores to buy back any type of objects

//TODO Create autoGenerated map?

//TODO create give command

//TODO create skillsValue
...
public class interpretationServer extends Thread {
	...
	public void room(){//Prints Description and exits of a room - called by interpretUsr()
		...
		out.println(setColor.color("[blue]" + exits + "[cyan]" + store + "[white]"));
	...
	public void interpretUsr(){//User Input
		...
		if (UV.isSleeping()) {
			...
			if (str.equals("n") | str.equals("north")) {
				...
				StringTokenizer sellToken = new StringTokenizer(orig);
